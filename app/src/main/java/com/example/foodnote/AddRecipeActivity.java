...
import com.example.foodnote.RecipeItem.Priority;
...
public class AddRecipeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mTitleText.setText("");
				mPriorityRadioGroup.check(Priority.MED.ordinal());
				setDefaultDateTime();
			}
		});
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// gather RecipeItem data
				String titleString = getRecipeTitle();
				String descriptionString = getDescription();
				String ingredients = getIngredients();
				String fullDate = dateString + " " + timeString;

				// Package RecipeItem data into an Intent
				Intent data = new Intent();
				RecipeItem.packageIntent(data, titleString, descriptionString, ingredients, fullDate);
	...
	private String getIngredients() {
		return mIngredients.getText().toString();
	}

	// DialogFragment used to pick a RecipeItem deadline date
	...
	// DialogFragment used to pick a RecipeItem deadline time
